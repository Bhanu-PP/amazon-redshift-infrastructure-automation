...
if not defined HEAP (
    ...
    set HEAP=-Xms5g -Xmx5g -XX:MaxMetaspaceSize=1g
)
...
%JM_START% "%JM_LAUNCH%" %ARGS% %JVM_ARGS% -jar "C:\JMETER\apache-jmeter-5.4.3\bin\ApacheJMeter.jar" %JMETER_CMD_LINE_ARGS%
